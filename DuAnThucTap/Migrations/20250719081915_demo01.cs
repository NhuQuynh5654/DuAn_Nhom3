        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Campuses_Schoolinformations_Schoolinfoid",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schoolyears_Schoolinformations_Schoolinfoid",
                        column: x => x.Schoolinfoid,
                        principalTable: "Schoolinformations",
                        principalColumn: "Schoolinfoid",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "TeacherConcurrentSubjects",
                columns: table => new
                {
                    TeacherID = table.Column<int>(type: "integer", nullable: false),
                    SubjectID = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherConcurrentSubjects", x => new { x.TeacherID, x.SubjectID, x.SchoolYearID });
                    table.ForeignKey(
                        name: "FK_TeacherConcurrentSubjects_Schoolyears_SchoolYearID",
                        column: x => x.SchoolYearID,
                        principalTable: "Schoolyears",
                        principalColumn: "Schoolyearid",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeacherConcurrentSubjects_Subjects_SubjectID",
                        column: x => x.SubjectID,
                        principalTable: "Subjects",
                        principalColumn: "Subjectid",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeacherConcurrentSubjects_Teachers_TeacherID",
                        column: x => x.TeacherID,
                        principalTable: "Teachers",
                        principalColumn: "Teacherid",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teachingassignments_Subjects_Subjectid1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Createdat = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Updatedat = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Schoolyearid1 = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Blockleaders_Schoolyears_Schoolyearid1",
                        column: x => x.Schoolyearid1,
                        principalTable: "Schoolyears",
                        principalColumn: "Schoolyearid");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Blockleaders_Schoolyearid1",
                table: "Blockleaders",
                column: "Schoolyearid1",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schoolyears_Schoolinfoid",
                table: "Schoolyears",
                column: "Schoolinfoid");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherConcurrentSubjects_SchoolYearID",
                table: "TeacherConcurrentSubjects",
                column: "SchoolYearID");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherConcurrentSubjects_SubjectID",
                table: "TeacherConcurrentSubjects",
                column: "SubjectID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachingassignments_Subjectid1",
                table: "Teachingassignments",
                column: "Subjectid1");
